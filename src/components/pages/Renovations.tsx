...
import { ArrowRight, ArrowUpRight, Hammer, Building2, Zap, Wind, Trees, Home, type LucideIcon } from 'lucide-react';
...
const renovationHeroExterior = '/images/renovation-hero-exterior.jpg';
const renovationBlueprintConsult = '/images/renovation-blueprint-consult.jpg';
const renoProjectDemo = '/images/reno-project.png';
...
const TRADES: TradeCard[] = [
  {
    ...
    copy: "The biggest-ticket, most-researched category. Homeowners want to see finished work before they'll pick up the phone — a filterable before/after gallery does more selling than any page of text.",
  },
  {
    icon: Building2,
    title: 'Additions & General Contracting',
    copy: "Bigger scope, longer timelines, more moving parts — permits, subtrades, structural work. What builds confidence isn't more photos, it's proof you can manage a complex project start to finish.",
  },
  {
    icon: Home,
    title: 'Roofing',
    copy: 'Often an urgent search — a storm just hit, or an inspection flagged something. A visible phone number and clear coverage area matter more than a polished portfolio.',
  },
  {
    icon: Wind,
    title: 'HVAC',
    copy: 'Split between emergency repairs and planned replacements. A site that serves both — an obvious emergency line and a straightforward maintenance-plan page — catches both kinds of searches.',
  },
  {
    icon: Zap,
    title: 'Electrical',
    copy: 'Licensing and safety lead the decision more than in any other trade. ESA licensing, insurance, and clear panel-upgrade or EV-charger pages do more work than a project gallery.',
  },
  {
    icon: Trees,
    title: 'Landscaping',
    copy: "Seasonal and highly visual — search volume spikes every spring. The sites that convert have a current, well-photographed portfolio, not one from three seasons ago.",
  },
];
...
const STATS = [
  {
    stat: '93%',
    label: 'Homeowners hiring a pro in 2026',
    description: 'General contractors are the single most-hired trade on renovation projects this year.',
    source: 'Houzz, 2026 U.S. Renovation Plans Report',
  },
  {
    stat: '97%',
    label: 'Read reviews before choosing a business',
    description: "If a homeowner can't find you — or finds an empty profile — you're not in the running.",
    source: 'BrightLocal, Local Consumer Review Survey 2026',
  },
  {
    stat: '54%',
    label: 'Visit the website after a good review',
    description: 'A strong review gets them curious. Your website is what turns curious into a phone call.',
    source: 'BrightLocal, Local Consumer Review Survey 2026',
  },
];
...
const FEATURES = [
  {
    title: 'Quote Requests That Include the Photo',
    description: 'A form that lets homeowners attach photos of their space up front turns your first call into a real scope conversation, not twenty minutes of back-and-forth over email.',
  },
  {
    title: 'Before/After Galleries by Project Type',
    description: "Filterable by kitchen, bathroom, addition, or basement — so someone planning a kitchen remodel isn't scrolling past six bathroom photos to find relevant work.",
  },
  {
    title: 'Licensing & Insurance, Not Buried',
    description: 'WSIB coverage, liability insurance, and trade certifications shown where homeowners actually look — not filed away on an About page nobody opens.',
  },
  {
    title: 'City Pages That Actually Rank',
    description: 'A dedicated page for each city you serve, built to rank for that city — not one generic paragraph trying to cover eight municipalities at once.',
  },
];
...
const demo = CONCEPT_DEMOS.renovations;
...
const Renovations = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px] lg:min-h-[700px] relative z-10">
          ...
          <div className="bg-slate-900/95 backdrop-blur-sm flex items-center py-12 sm:py-16 md:py-20 lg:py-24 px-6 sm:px-8 md:px-12 lg:px-16 border-r border-slate-800/50 pt-24 sm:pt-28 md:pt-32 lg:pt-40">
            <div className="w-full max-w-2xl mx-auto lg:mx-0">
              ...
              <TextReveal
                ...
                staggerMs={110}
                lines={[
                  <span key="l1" className="font-light opacity-90">Contractor &amp; Renovation</span>,
              ...
              <FadeIn delay={260}>
                <p className="text-base sm:text-lg text-white/70 leading-relaxed mb-8 font-light tracking-[0.01em]">
                  Built for kitchen and bath remodelers, general contractors, roofers, electricians, HVAC techs, and landscapers. A site that shows finished work, earns trust fast, and turns visitors into quote requests.
                </p>
              </FadeIn>
          ...
          <div className="relative h-[400px] lg:h-auto overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
              <SafeImage
                src={renovationHeroExterior}
                alt="Modern renovated home exterior at dusk — GTA contractor and renovation web design"
      ...
      {/* ===== Trades — editorial numbered list ===== */}
      <section className="py-20 sm:py-24 md:py-28 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <TextReveal
            ...
            staggerMs={120}
            lines={[
              <span key="l1" className="block font-light">Every Trade Sells</span>,
          ...
          <FadeIn delay={200}>
            <p className="text-white/50 text-center mb-14 sm:mb-16 text-base sm:text-lg max-w-2xl mx-auto leading-[1.7] font-light">
              A roofer and a landscaper don&apos;t win the same way online. We build each site around how that trade&apos;s customers actually search and decide.
            </p>
          </FadeIn>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12">
            {TRADES.map((trade, index) => (
              <FadeIn key={trade.title} delay={index * 70}>
                <div className={`group flex items-start gap-5 py-7 ${index >= 2 ? 'border-t border-white/10' : ''}`}>
                  ...
                  <div>
                    <div className="flex items-center gap-2.5 mb-2">
                      <trade.icon className="w-4 h-4 text-cyan-400/70 flex-shrink-0" strokeWidth={2} />
                      <h3 className="text-white font-medium text-lg group-hover:text-cyan-300 transition-colors duration-300">{trade.title}</h3>
                    </div>
                    <p className="text-white/50 text-sm leading-relaxed font-light">{trade.copy}</p>
                  </div>
                </div>
              </FadeIn>
            ))}
      ...
      {/* ===== Divider — brand mark, straddling the seam between Trades and Research ===== */}
      {/* A zero-height sibling, outside both sections' overflow-hidden, so the badge isn't clipped. */}
            ...
            <div>
              ...
              <TextReveal
                ...
                lines={[
                  ...
                  <span key="l2" className="block mt-1 bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient font-normal pb-1">Phone Call.</span>,
                ]}
              />
              <FadeIn delay={220}>
                <div className="space-y-5 text-white/60 text-base leading-[1.75] font-light">
                  <p>Renovation projects rarely start with a call anymore — they start with a search. Most homeowners bring in a professional, and by the time they reach out, they&apos;ve usually already narrowed the field to a couple of names.</p>
                  <p>That narrowing happens online. Reviews are the first filter, and roughly half the people who read a good one go on to check that business&apos;s website. Your reviews get you noticed — your website turns that notice into a call.</p>
                </div>
              </FadeIn>
            </div>
            <FadeIn delay={150}>
              <SafeImage
                src={renovationBlueprintConsult}
                alt="Homeowner and contractor reviewing a renovation floor plan"
            ...
            <FadeIn className="order-2 lg:order-1">
              ...
              >
                ...
                <div className="aspect-[16/10] relative bg-slate-900">
                  <SafeImage
                    src={renoProjectDemo}
                    alt={`${demo.name} — concept renovation company website`}
            ...
            <div className="order-1 lg:order-2">
              ...
              <FadeIn delay={220}>
                <p className="text-white/60 text-base leading-[1.75] font-light">
                  A site built around how homeowners actually shop for a contractor — not a generic build with your name swapped in.
                </p>
              </FadeIn>
            </div>
          </div>
      ...
      <section id="quote" className="scroll-mt-24 py-20 sm:py-24 md:py-28 relative overflow-hidden bg-gradient-to-br from-slate-900 via-cyan-900/25 to-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-16">
            ...
            <FadeIn delay={100}>
              <MiniContactForm
                id="renovations-quote"
                projectType="Renovation & Contractor Website"
                heading="Get a Free Quote"
                subheading="Tell us about your trade and your service area — we'll follow up within 24–48 hours with next steps and a fixed-price estimate."
                messagePlaceholder="What trade are you in, and what would you like your website to do for you?"
              />
            </FadeIn>
          </div>
        </div>
