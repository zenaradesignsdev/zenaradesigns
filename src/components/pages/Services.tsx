...
import { Star, ArrowRight, CheckCircle, Layers, Heart, ChevronLeft, ChevronRight, Rocket, TrendingUp, ChevronDown, Scale, Calculator, Hammer, Globe, ShoppingCart, Paintbrush, CreditCard, Search, Server } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extralight mb-6 sm:mb-8 leading-[0.95] tracking-[-0.04em]">
              <span className="font-light opacity-90 text-white">Explore Our </span>
              <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient font-normal">Services</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/60 max-w-3xl mx-auto leading-[1.7] font-light tracking-[0.01em] px-4">
              Dive deeper into each of our specialized service offerings.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 tracking-tight">{service.title}</h3>
                    <p className="text-white/60 text-sm sm:text-base leading-[1.7] font-light tracking-[0.01em] mb-4">{service.desc}</p>
