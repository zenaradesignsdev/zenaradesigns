          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-4 mb-10 sm:mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extralight text-white tracking-[-0.03em]">
                <span className="font-light opacity-90">More </span>
                <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient font-normal">Articles</span>
              </h2>
            </div>
