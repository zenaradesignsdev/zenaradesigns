...
const lawyerConsultationDocument = '/images/lawyer-consultation-document.png';
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-20 md:pb-24 relative z-10">
        ...
        <section 
          ...
          ref={(el) => {
            if (el) sectionRefs.current.set('transformation', el as HTMLDivElement);
          }}
        ...
        <section 
          ...
          ref={(el) => {
            if (el) sectionRefs.current.set('first-impression', el as HTMLDivElement);
          }}
        ...
        <section 
          ...
          ref={(el) => {
            if (el) sectionRefs.current.set('gta-coverage', el as HTMLDivElement);
          }}
          className={`mb-16 sm:mb-20 md:mb-24 transition-all duration-1000 ${
        ...
        <section 
          ...
          ref={(el) => {
            if (el) sectionRefs.current.set('process', el as HTMLDivElement);
          }}
          className={`mb-16 sm:mb-20 md:mb-24 transition-all duration-1000 ${
        ...
        <section 
          data-section-id="faq"
          ref={(el) => {
            if (el) sectionRefs.current.set('faq', el as HTMLDivElement);
          }}
          className={`mb-16 sm:mb-20 md:mb-24 transition-all duration-1000 ${
