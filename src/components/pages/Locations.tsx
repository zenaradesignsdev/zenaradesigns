...
const locations = [
    ...
    {
      city: "Hamilton",
      description: "Web design services for Hamilton businesses, from the downtown core to the mountain and surrounding communities.",
      services: ["Web Design Hamilton", "Business Cards Hamilton", "Logo Design Hamilton", "E-commerce Development Hamilton"],
      neighborhoods: ["Downtown Hamilton", "Westdale", "Dundas", "Ancaster", "Stoney Creek", "Waterdown"]
    },
    {
      city: "Scarborough",
      description: "Professional web design for Scarborough businesses, serving one of Toronto's most diverse and vibrant communities.",
      services: ["Web Design Scarborough", "Business Cards Scarborough", "Logo Design Scarborough", "Small Business Websites Scarborough"],
      neighborhoods: ["Scarborough Town Centre", "Agincourt", "Malvern", "Birch Cliff", "Guildwood", "West Hill"]
    },
    {
      city: "North York",
      description: "Modern web design services for North York businesses along the Yonge Street corridor and surrounding neighbourhoods.",
      services: ["Web Design North York", "Business Cards North York", "Logo Design North York", "Corporate Websites North York"],
      neighborhoods: ["North York Centre", "Willowdale", "Don Mills", "Bayview Village", "York Mills", "Lansing"]
    },
    {
      city: "Etobicoke",
      description: "Custom web design for Etobicoke businesses, from the lakefront communities to the vibrant commercial districts.",
      services: ["Web Design Etobicoke", "Business Cards Etobicoke", "Logo Design Etobicoke", "Business Website Etobicoke"],
      neighborhoods: ["Islington", "Mimico", "New Toronto", "Long Branch", "Kingsway", "Rexdale"]
    },
    {
      city: "Ajax",
      description: "Professional web design solutions for Ajax businesses, serving the growing Durham Region community.",
      services: ["Web Design Ajax", "Business Cards Ajax", "Logo Design Ajax", "Digital Marketing Ajax"],
      neighborhoods: ["Downtown Ajax", "Pickering Beach", "South Ajax", "Salem", "Audley", "Carruthers Creek"]
    }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/60 max-w-4xl mx-auto leading-[1.7] font-light tracking-[0.01em] px-4">
            Professional web design, business card design, and logo design services for businesses in Toronto, Mississauga, Brampton, Vaughan, Markham, Richmond Hill, Oakville, Burlington, Hamilton, Scarborough, North York, Etobicoke, and Ajax
          </p>
        </div>
        ...
        <div className="bg-slate-900/90 backdrop-blur-sm rounded-2xl p-8 sm:p-10 md:p-12 border border-slate-800/50 shadow-2xl relative overflow-hidden mb-16 sm:mb-20">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div className="text-center group">
                <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/50 group-hover:border-cyan-500/50 transition-all duration-300">
                  <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient mb-2">80+</div>
