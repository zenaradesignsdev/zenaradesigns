  ...
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">The Digital Shift: Statistics That Matter</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
        The numbers don't lie. According to recent studies, <strong className="text-cyan-300 font-semibold">over 80% of consumers 
        ...
        the impact—<strong className="text-cyan-300 font-semibold">97% of consumers search online for local products and services</strong>, 
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">The Generation Gap: Why Younger Customers Demand Online Presence</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
        Millennials and Gen Z—the largest consumer groups today—have grown up with the internet. For them, 
        <strong className="text-cyan-300 font-semibold"> not having a website is like not having a phone number in the 1990s</strong>. 
      ...
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
        Research shows that <strong className="text-cyan-300 font-semibold">68% of millennials prefer to discover new businesses 
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">Your Website is Your Reputation</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
      ...
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
        Conversely, <strong className="text-cyan-300 font-semibold">not having a website—or having a poorly designed one—can 
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">24/7 Availability: Your Business Never Sleeps</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">Cost-Effective Marketing and Growth</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
      ...
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
        For small businesses and personal brands, this efficiency is crucial. <strong className="text-cyan-300 font-semibold">A 
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mt-10 sm:mt-12 mb-4 sm:mb-6 tracking-tight">
        <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">The Bottom Line</span>
      </h2>
      <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] mb-6">
      ...
      <div className="bg-slate-900/90 backdrop-blur-sm rounded-xl p-6 sm:p-8 mt-10 sm:mt-12 mb-6 border border-slate-800/50 relative overflow-hidden">
        ...
        <h3 className="text-xl sm:text-2xl font-semibold text-white mb-4 relative z-10 tracking-tight">
          <span className="bg-gradient-to-r from-cyan-300 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">Ready to Build Your Online Presence?</span>
        </h3>
        ...
        <p className="text-white/60 text-base sm:text-lg leading-[1.7] font-light tracking-[0.01em] relative z-10">
          <strong className="text-cyan-300 font-semibold">Contact us today</strong> to discuss how we can help you establish 
